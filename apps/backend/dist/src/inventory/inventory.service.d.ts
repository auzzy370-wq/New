...
export declare class InventoryService {
    ...
    adjust(merchantId: string, params: {
        locationId: string;
        productId: string;
        variantId?: string;
        quantity: number;
    ...
    processOrderInventory(orderId: string, merchantId: string): Promise<void>;
    restoreOrderInventory(orderId: string, merchantId: string, items?: Array<{
        productId: string;
        variantId?: string;
        quantity: number;
    }>): Promise<void>;
